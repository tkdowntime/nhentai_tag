...
print("\nThe program will prompt you first for tags you want to see in your hentai.\n"
...
while True:
    ...
    elif in_tags in include:
        print(f"You already have '{in_tags}' in your include tag")
...
while True:
    ...
    elif out_tags in exclude:
        print(f"You already have '{out_tags}' tag in your exclude list.")
    else:
